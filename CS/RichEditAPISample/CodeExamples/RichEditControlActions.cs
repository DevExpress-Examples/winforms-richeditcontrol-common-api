...
namespace RichEditAPISample.CodeExamples {
    public static class RichEditControlActions {
        ...
        static void ShowSearchFormMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to invoke the 'Find and Replace' dialog switched to the 'Find' tab and with the 'test' word used for search";
        ...
        static void SaveDocumentMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to display a confirmation window to save a document.\r\n";
        ...
        static void PrintDocumentMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to print a current document to the default printer\r\n\r\n\r\n";
        ...
        static void PasteTextFromClipboardMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to paste text from the system clipboard into a current document's position\r\n\r\n\r\n";
        ...
        static void MailMergeMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to perform the 'Mail Merge' operation\r\n";
        ...
        static void LoadDocumentTemplateMethod(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to load the 'LoremDocumentTest' document as a template document.\r\n";
        ...
        static void buttonCustomAction_ItemClick_LoadDocument(object sender, ItemClickEventArgs e) {
            ...
            using(FileStream fs = new FileStream("Documents\\tesDocumentHTML.html", FileMode.Open)) {
        ...
        static void ExportDocumentToPdfFormat(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl ";
            richEditControl.Text += "to load the 'DocumentServerTest.docx' file into RichEditControl's document and export the document into PDF format\r\n";
        ...
        static void buttonCustomAction_ItemClick_PDF(object sender, ItemClickEventArgs e) {
            RichEditControl richEdit = e.Item.Tag as RichEditControl;
            richEdit.LoadDocument("Documents\\DocumentServerTest.docx", DevExpress.XtraRichEdit.DocumentFormat.OpenXml);
            richEdit.ExportToPdf("resultDocument.pdf");
            System.Diagnostics.Process.Start("resultDocument.pdf");
        }
        ...
        static void DeselectAllTextInDocument(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Select text in a document and сlick the 'Custom Action' button located on the RibbonControl.\r\n";
        ...
        static void buttonCustomAction_ItemClick_Cut(object sender, ItemClickEventArgs e) {
            RichEditControl richEdit = e.Item.Tag as RichEditControl;
            DocumentRange[] foundedRanges = richEdit.Document.FindAll("Custom Action", SearchOptions.None);
            for(int i = 0; i < foundedRanges.Length; i++) {
        ...
        static void CreateAndExecuteCommands(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            buttonCustomAction.Tag = richEditControl;
            richEditControl.Text = "Click the 'Custom Action' button located on the RibbonControl to capitalize each word in this text,\r\n";
        ...
        static void CopySelectedText(RichEditControl richEditControl, BarButtonItem buttonCustomAction) {
            ...
            DocumentRange[] foundedRanges = richEditControl.Document.FindAll("text from RichEditControl", SearchOptions.None);
