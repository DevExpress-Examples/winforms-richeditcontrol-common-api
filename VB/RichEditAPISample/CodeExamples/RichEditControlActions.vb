...
'			#End Region ' #GetBoundsFromDocumentPositionAdditionalModules
		...
		Private Shared Sub ExportDocumentToPdfFormat(ByVal richEditControl As RichEditControl, ByVal buttonCustomAction As BarButtonItem)
'			#Region "#ExportDocumentToPdfFormat"
			...
			richEditControl.Text &= "to load the 'DocumentServerTest.docx' file into RichEditControl's document and export the document into PDF format" & Constants.vbCrLf
'			#End Region ' #ExportDocumentToPdfFormat
		End Sub

'			#Region "#ExportDocumentToPdfFormatCustomActionHandler"
		Private Shared Sub buttonCustomAction_ItemClick_PDF(ByVal sender As Object, ByVal e As ItemClickEventArgs)
			Dim richEdit As RichEditControl = TryCast(e.Item.Tag, RichEditControl)
